...
// FIXED: Dynamic min_stock_level logic
if ($stockStatus !== '') {
    if ($stockStatus === 'out-of-stock') {
        ...
        // FIXED: Use dynamic min_stock_level instead of hardcoded 15
...
$items = array_map(function ($r) use ($baseImg) {
    ...
    // Determine stock status and level
    ...
    return [
        ...
        'name' => $r['product_name'],
        'code' => $r['product_code'],
        'sku' => $r['product_code'], // Alias for frontend compatibility
