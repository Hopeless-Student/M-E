  ...
  <body>
    ...
    <div class="container">
      <div class="terms-container">
        ...
        <h2 class="sub">1. Introduction</h2>
          <p class="lead">Welcome to M&E Interior Trading Supplies. By using our website and services, you agree to these Terms &amp; Conditions. Please read them carefully.</p>


          <h3 class="sub">2. Using our service</h3>
          ...
          <h3 class="sub">3. Orders &amp; Payment</h3>
          ...
          <h3 class="sub">6. Limitation of Liability</h3>
