...
<head>
  ...
  <!-- <style>
    ...
    .navbar-nav .nav-link.active {
      font-weight: bold;
      color: #ffcc00; /* Example color for active link */
    }
    ...
    .category-card {
      ...
      .category-card:hover {
        transform: scale(1.05);      /* zoom entire card */
        box-shadow: 0 8px 20px rgba(0,0,0,0.15);
      }
      .category-img {
         width: 100%;
         min-height: 200px;  /* can grow if card is taller */
         object-fit: cover;
         border-radius: 12px;
...
<!-- Navbar -->
  <nav class="navbar navbar-expand-lg bg-transparent sticky-top px-4 py-2 custom-navbar">
    ...
    <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
      <li class="nav-item"><a class="nav-link active" href="../pages/about.php">Home</a></li>
      <li class="nav-item"><a class="nav-link" href="../pages/order_form.php">Products</a></li>
