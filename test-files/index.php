...
$sql = "
  SELECT u.user_id, u.first_name, u.last_name, u.email, u.contact_number, u.address, u.created_at,
                ...
                <div class="table-container">
                  ...
                  <?php foreach ($customers as $c): ?>
                    <tr>
                      <td>
                        <div class="customer-info">
                          ...
                          <div class="customer-details">
                            <h4><?= htmlspecialchars($c['first_name'] . " " . $c['last_name']) ?></h4>
                            <p>Member since <?= date("M Y", strtotime($c['created_at'])) ?></p>
                          </div>
                        </div>
                      </td>
                      ...
                      <td>
                        <div class="actions">
                          <a href="user-details.php?id=<?= $c['user_id'] ?>" class="action-btn">View</a>
                          <a href="user-orders.php?id=<?= $c['user_id'] ?>" class="action-btn orders">Orders</a>
                          <a href="edit-user.php?id=<?= $c['user_id'] ?>" class="action-btn secondary">Edit</a>
                        </div>
                      </td>
                    </tr>
                  <?php endforeach; ?>
