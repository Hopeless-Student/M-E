  ...
  if(isset($_GET['id'])){
    ...
    // echo $user_id;
    try {
      $sql = " SELECT u.user_id, u.first_name, u.last_name, u.email, u.contact_number,
      COUNT(o.order_id) AS total_orders,
      COALESCE(SUM(o.final_amount), 0) AS total_spent,
      COALESCE(ROUND(AVG(o.final_amount)), 0) AS avg_spent
      FROM users u
      LEFT JOIN orders o ON u.user_id = o.user_id
      WHERE u.user_id = :user_id
      GROUP BY u.user_id,u.first_name, u.last_name, u.email, u.contact_number
      ";
      // echo $sql;
    ...
    <div class="dashboard">
        ...
        <main class="main-content">
              ...
              <div class="customer-profile">
                  <div class="profile-header">
                      ...
                      <div class="profile-info">
                          ...
                          <h3><?=htmlspecialchars($customers['first_name'] . " " . $customers['last_name'])?></h3>
                          <p><?= htmlspecialchars($customers['email']) ?></p>
                          <p><?= htmlspecialchars($customers['contact_number']) ?></p>
                          <p>Customer ID: #CUS-<?= htmlspecialchars($customers['user_id']) ?></p>
                          <?php if ($customers['total_orders'] == 0): ?>
                            <span class="status-badge new">New</span>
                          <?php elseif ($customers['total_orders'] > 0): ?>
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    <div class="stat-value"><?=htmlspecialchars($customers['total_orders'])?></div>
                    <div class="stat-label">Total Orders</div>
                    <div class="stat-change positive">+2 this month</div>
                </div>
                <div class="stat-card">
                    <div class="stat-value">₱<?=htmlspecialchars($customers['total_spent'])?></div>
                    <div class="stat-label">Total Spent</div>
                    <div class="stat-change positive">+₱850 this month</div>
                </div>
                <div class="stat-card">
                    <div class="stat-value">₱<?=htmlspecialchars($customers['avg_spent'],2)?></div>
                ...
                <div class="info-section">
                    ...
                    <div class="section-content">
                        <div class="info-row">
                            ...
                            <span class="info-value"><?=htmlspecialchars($customers['first_name'] . " " . $customers['last_name'])?></span>
                        </div>
                        <div class="info-row">
                            <span class="info-label">Email</span>
                            <span class="info-value"><?= htmlspecialchars($customers['email']) ?></span>
                        </div>
                        <div class="info-row">
